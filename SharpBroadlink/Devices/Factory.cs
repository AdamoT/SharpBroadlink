	...
	internal class Factory
	{
        ...
        private static readonly Dictionary<string, int[]> Devices
			= new Dictionary<string, int[]>
			{
				...
				{"Hysen", new[] {0x4EAD}}, // Hysen controller
				{"S1c", new[] {0x2722}}, // S1 (SmartOne Alarm Kit)
				{"Dooya", new[] {0x4E4D}} // Dooya DT360E (DOOYA_CURTAIN_V2)
			};
        ...
        /// </remarks>
        internal static IDevice GenDevice(int devType, IPEndPoint host, byte[] mac)
		{
			var devicePair = Devices
			...
			{
				result = new Device(host, mac, devType);
			}
			else
			{
